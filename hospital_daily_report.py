...
def main():
	...
	dirname_input = '/home/nwtquinn/public_ftp/incoming/sjvda-realtime.org/SJVDA/hospitalcreek/'
	dirname_output = '/home/nwtquinn/public_ftp/daily_report/SJVDA_reports/hospitalcreek_daily_report.csv'
	today = date.today()
